...
```bash
# 1. Clone the repo
git clone https://github.com/your-username/metaflow-xml.git
cd metaflow-xml
...
Replace `workflow.xml` in the repo root with your own workflow XML before running. The file must follow the [metaflow-xml schema](examples/haffner_2022/metabolomics_workflow.xml) and include a MassIVE repository entry:
